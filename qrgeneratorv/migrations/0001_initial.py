    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('sms_service', models.IntegerField(help_text='Date of SMS Cervice', verbose_name='Сервис отправки SMS')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='qrcodes', to='qrgeneratorv.template')),
